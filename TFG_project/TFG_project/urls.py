...
urlpatterns = [
    ...
    path('paciente/', login_required(views.crearPaciente), name='paciente'),
    path('paciente/<int:id>/', login_required(views.crearPaciente2), name='paciente_id'),
